...
def meteo_api_response() -> str:
    res = {
        "latitude": 59.9293,
        "longitude": 30.317093,
        "generationtime_ms": 2.460002899169922,
...
@pytest.mark.asyncio
async def test_meteo_api(
    mocked: Any, meteo_api: OpenMeteApi, meteo_api_response: str
) -> None:
    mocked.get(
        "http://test_meteo_api.com?latitude=59.938732&longitude=30.316229&hourly=temperature_2m,windspeed_10m",
        status=200,
